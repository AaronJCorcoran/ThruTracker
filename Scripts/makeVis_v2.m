function makeVis_v2(dispTracks,summ,figHandle)
...
VisT=patch('Faces',turbine.obj.f.v,'Vertices',turbine.obj.vR_trans);
...
if ~isempty(dispTracks)
    ...
    figHandle.Pointer='crosshair'; % so that the user knows when track selection is active
end
hold off
